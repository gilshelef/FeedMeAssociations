...
//            takeAction = mContext.getDrawable(R.drawable.save);
...
//
//        //Donation image
//        if(current.getImageUrl().isEmpty()) {// image not provided
//            Drawable drawable = mContext.getDrawable(current.getDefaultImage());
